...
const _page1 = () => import('./pages/api/results/sendemail.astro.mjs');
const _page2 = () => import('./pages/api/results/_test_.astro.mjs');
const _page3 = () => import('./pages/caracterograma.astro.mjs');
const _page4 = () => import('./pages/test_liderazgo.astro.mjs');
const _page5 = () => import('./pages/tests/caracterograma.astro.mjs');
const _page6 = () => import('./pages/tests/test_liderazgo.astro.mjs');
const _page7 = () => import('./pages/index.astro.mjs');

const pageMap = new Map([
    ["node_modules/.pnpm/astro@4.12.2_typescript@5.5.4/node_modules/astro/dist/assets/endpoint/generic.js", _page0],
    ["src/pages/api/results/sendEmail.ts", _page1],
    ["src/pages/api/results/[test].ts", _page2],
    ["src/pages/caracterograma.astro", _page3],
    ["src/pages/test_liderazgo.astro", _page4],
    ["src/pages/tests/caracterograma.astro", _page5],
    ["src/pages/tests/test_liderazgo.astro", _page6],
...
const _args = {
    "middlewareSecret": "ffcf73c4-af0d-4abe-b9cb-aec92aa51312",
